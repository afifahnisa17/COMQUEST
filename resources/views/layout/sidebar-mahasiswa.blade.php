        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="{{ url('mahasiswa/beranda') }}" aria-expanded="{{ Request::is('mahasiswa/beranda*') ? 'true' : 'false' }}">
                    ...
                    <li class="menu">
                        <a href="{{ url('mahasiswa/prestasi') }}" aria-expanded="{{ Request::is('mahasiswa/prestasi*') ? 'true' : 'false' }}">
                    ...
                    <li class="menu">
                        <a href="{{ url('mahasiswa/lomba') }}" aria-expanded="{{ Request::is('mahasiswa/lomba*') ? 'true' : 'false' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <li class="menu">
                        <a href="{{ url('mahasiswa/bimbingan-form') }}" aria-expanded="{{ Request::is('mahasiswa/bimbingan-form*') ? 'true' : 'false' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
